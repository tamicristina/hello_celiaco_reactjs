        ...
        <div className="contaminacao_div_text">
          <div className="contaminacao_div_text_paragrado">
            ...
            <p>
              ...
              composição e não podem ser consumidos por celíacos. Por exemplo,
              um produto sem glúten embalado na mesma máquina que se embala
              produtos com glúten. A contaminação também é frequente em silos de
              armazenagem e transporte de alimentos, por isso todas as vezes que
              descobrir um produto novo isento de glúten o celíaco deve entrar
              em contato com o SAC para verificar se é seguro para o consumo.
              Outro exemplo clássico é o reaproveitamento de óleo para frituras,
              em um mesmo recipiente frita-se pastel e batatas, certamente
              partículas de glúten vão aderir as batatas causando danos ao
              celíaco.
            </p>
          </div>
          <span className="contaminacao_image_container">
            <img
              className="contaminacao_image"
              src="https://i.ibb.co/b1sT2ww/undraw-medicine-b1ol.png"
            />
          </span>
        </div>
